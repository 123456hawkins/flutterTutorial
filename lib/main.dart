  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton:Stack(
          children: <Widget>[Positioned(bottom: 80.0,right: 10.0,child:FloatingActionButton(
            onPressed: _incrementCounter,
            tooltip: 'Increment',
            child: const Icon(Icons.add),
          )),
            Positioned(bottom: 80.0,right: 80.0,child:FloatingActionButton(
              onPressed:_decrementCounter,tooltip: 'Decrement',child: const Icon(Icons.delete),
            )),
            Positioned(bottom: 80.0,right: 150.0,child:FloatingActionButton(
              onPressed:_decrementCounter,tooltip: 'Decrement',child: const Icon(Icons.delete),
            ))
          ],
        )
...
class _TapboxCState extends State<TapboxC>{
  ...
  void _handleTapUp(TapUpDetails details){
    Timeline.startSync('performance Function');
    setState(() {
      _highlight=false;
    });
    Timeline.finishSync();
